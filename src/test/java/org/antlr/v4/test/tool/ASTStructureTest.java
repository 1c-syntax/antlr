...
class ASTStructureTest {
  ...
  @Test
  void test_grammarSpec1() throws Exception {
  ...
  @Test
  void test_delegateGrammars1() throws Exception {
    ...
    assertThat(actual).as("testing rule delegateGrammars").isEqualTo(expecting);
  }

  @Test
  void test_rule1() throws Exception {
  ...
  @Test
  void test_rule2() throws Exception {
  ...
  @Test
  void test_ebnf1() throws Exception {
    // gunit test on line 123
    RuleReturnScope rstruct = (RuleReturnScope) execParser("ebnf", "(A|B)", 123);
    Object actual = ((Tree) rstruct.getTree()).toStringTree();
    Object expecting = "(BLOCK (ALT A) (ALT B))";
    assertThat(actual).as("testing rule ebnf").isEqualTo(expecting);
  }

  @Test
  void test_ebnf2() throws Exception {
  ...
  @Test
  void test_ebnf3() throws Exception {
  ...
  @Test
  void test_ebnf4() throws Exception {
  ...
  @Test
  void test_element1() throws Exception {
    // gunit test on line 129
    RuleReturnScope rstruct = (RuleReturnScope) execParser("element", "~A", 129);
    Object actual = ((Tree) rstruct.getTree()).toStringTree();
    Object expecting = "(~ (SET A))";
    assertThat(actual).as("testing rule element").isEqualTo(expecting);
  }

  @Test
  void test_element2() throws Exception {
  ...
  @Test
  void test_element3() throws Exception {
  ...
  @Test
  void test_element4() throws Exception {
  ...
  @Test
  void test_element5() throws Exception {
  ...
  @Test
  void test_element6() throws Exception {
  ...
  @Test
  void test_element7() throws Exception {
  ...
  @Test
  void test_element8() throws Exception {
  ...
  @Test
  void test_element9() throws Exception {
  ...
  @Test
  void test_element10() throws Exception {
  ...
  @Test
  void test_element11() throws Exception {
  ...
  @Test
  void test_element12() throws Exception {
  ...
  @Test
  void test_element13() throws Exception {
  ...
  @Test
  void test_element14() throws Exception {
  ...
  @Test
  void test_element15() throws Exception {
  ...
  @Test
  void test_element16() throws Exception {
  ...
  @Test
  void test_element17() throws Exception {
  ...
  @Test
  void test_element18() throws Exception {
  ...
  @Test
  void test_element19() throws Exception {
  ...
  @Test
  void test_element20() throws Exception {
  ...
  @Test
  void test_element21() throws Exception {
  ...
  @Test
  void test_element22() throws Exception {
  ...
  @Test
  void test_element23() throws Exception {
  ...
  @Test
  void test_element24() throws Exception {
