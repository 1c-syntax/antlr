...
public class ErrorQueue implements ANTLRToolListener {
  ...
  public final List<ANTLRMessage> errors = new ArrayList<>();
  public final List<ANTLRMessage> warnings = new ArrayList<>();
  public final List<ANTLRMessage> all = new ArrayList<>();
