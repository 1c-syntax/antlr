...
public class TestFullContextParsing extends BaseTest {
	...
	@Ignore @Test public void testCtxSensitiveDFATwoDiffInputWithoutDFA() {
		String grammar =
			"grammar T;\n"+
			"s @after {dumpDFA();}\n" +
			"  : ('$' a | '@' b)+ ;\n" +
	...
	@Ignore @Test public void testCtxSensitiveDFATwoDiffInputWithDFA() {
		String grammar =
			"grammar T;\n"+
			"s @init{getInterpreter().enable_global_context_dfa = true;} @after {dumpDFA();}\n" +
			"  : ('$' a | '@' b)+ ;\n" +
	...
	@Ignore @Test public void testFullContextIF_THEN_ELSEParseWithoutDFA() {
		String grammar =
			"grammar T;\n"+
			"s" +
			"@init {_interp.setPredictionMode(PredictionMode.LL_EXACT_AMBIG_DETECTION);}\n" +
	...
	@Ignore @Test public void testFullContextIF_THEN_ELSEParseWithDFA() {
		String grammar =
			"grammar T;\n"+
			"s" +
