...
public class TestIntervalSet extends BaseTest {
	...
	@Ignore @Test public void testMin() throws Exception {
	...
	@Ignore @Test public void testIsolatedElements() throws Exception {
    ...
    @Ignore @Test public void testMixedRangesAndElements() throws Exception {
        IntervalSet s = new IntervalSet();
        s.add(1);
        s.add('a','z');
        s.add('0','9');
    ...
    @Ignore @Test public void testSimpleAnd() throws Exception {
    ...
    @Ignore @Test public void testRangeAndIsolatedElement() throws Exception {
	...
	@Ignore @Test public void testEmptyIntersection() throws Exception {
		IntervalSet s = IntervalSet.of('a','z');
	...
	@Ignore @Test public void testEmptyIntersectionSingleElements() throws Exception {
    ...
    @Ignore @Test public void testNotSingleElement() throws Exception {
	...
	@Ignore @Test public void testNotEqualSet() throws Exception {
		IntervalSet vocabulary = IntervalSet.of(1,1000);
	...
	@Ignore @Test public void testNotSetEdgeElement() throws Exception {
    ...
    @Ignore @Test public void testNotSetFragmentedVocabulary() throws Exception {
    ...
    @Ignore @Test public void testSubtractOfCompletelyContainedRange() throws Exception {
        IntervalSet s = IntervalSet.of(10,20);
	...
	@Ignore @Test public void testSubtractFromSetWithEOF() throws Exception {
		IntervalSet s = IntervalSet.of(10,20);
		s.add(Token.EOF);
		IntervalSet s2 = IntervalSet.of(12,15);
	...
	@Ignore @Test public void testSubtractOfOverlappingRangeFromLeft() throws Exception {
		IntervalSet s = IntervalSet.of(10,20);
    ...
    @Ignore @Test public void testSubtractOfOverlappingRangeFromRight() throws Exception {
        IntervalSet s = IntervalSet.of(10,20);
    ...
    @Ignore @Test public void testSubtractOfCompletelyCoveredRange() throws Exception {
        IntervalSet s = IntervalSet.of(10,20);
    ...
    @Ignore @Test public void testSubtractOfRangeSpanningMultipleRanges() throws Exception {
        IntervalSet s = IntervalSet.of(10,20);
        s.add(30,40);
	 ...
	 */
	@Ignore @Test public void testSubtractOfWackyRange() throws Exception {
    ...
    @Ignore @Test public void testSimpleEquals() throws Exception {
        IntervalSet s = IntervalSet.of(10,20);
    ...
    @Ignore @Test public void testEquals() throws Exception {
        IntervalSet s = IntervalSet.of(10,20);
        s.add(2);
        s.add(499,501);
        IntervalSet s2 = IntervalSet.of(10,20);
    ...
    @Ignore @Test public void testSingleElementMinusDisjointSet() throws Exception {
    ...
    @Ignore @Test public void testMembership() throws Exception {
        IntervalSet s = IntervalSet.of(15,15);
        s.add(50,60);
    ...
    // {2,15,18} & 10..20
    @Ignore @Test public void testIntersectionWithTwoContainedElements() throws Exception {
        IntervalSet s = IntervalSet.of(10,20);
    ...
    @Ignore @Test public void testIntersectionWithTwoContainedElementsReversed() throws Exception {
        IntervalSet s = IntervalSet.of(10,20);
        IntervalSet s2 = IntervalSet.of(2,2);
        s2.add(15);
        s2.add(18);
    ...
    @Ignore @Test public void testComplement() throws Exception {
	...
	@Ignore @Test public void testComplement2() throws Exception {
	...
	@Ignore @Test public void testComplement3() throws Exception {
    ...
    @Ignore @Test public void testMergeOfRangesAndSingleValues() throws Exception {
        // {0..41, 42, 43..65534}
    ...
    @Ignore @Test public void testMergeOfRangesAndSingleValuesReverse() throws Exception {
    ...
    @Ignore @Test public void testMergeWhereAdditionMergesTwoExistingIntervals() throws Exception {
	 ...
	 */
	@Ignore @Test public void testMergeWhereAdditionMergesThreeExistingIntervals() throws Exception {
		IntervalSet s = new IntervalSet();
		s.add(0);
		s.add(3);
		s.add(5);
	...
	@Ignore @Test public void testMergeWithDoubleOverlap() throws Exception {
	...
	@Ignore @Test public void testSize() throws Exception {
	...
	@Ignore @Test public void testToList() throws Exception {
	...
	/** The following was broken:
	    ...
	    {'\u0000'..'q', 's'}!!!! broken...
	 	...
	 	'u' is 117
	*/
	@Ignore @Test public void testNotRIntersectionNotT() throws Exception {
    ...
    @Ignore @Test public void testRmSingleElement() throws Exception {
        IntervalSet s = IntervalSet.of(1,10);
        s.add(-3,-3);
        s.remove(-3);
    ...
    @Ignore @Test public void testRmLeftSide() throws Exception {
        IntervalSet s = IntervalSet.of(1,10);
        s.add(-3,-3);
        s.remove(1);
    ...
    @Ignore @Test public void testRmRightSide() throws Exception {
        IntervalSet s = IntervalSet.of(1,10);
        s.add(-3,-3);
        s.remove(10);
    ...
    @Ignore @Test public void testRmMiddleRange() throws Exception {
        IntervalSet s = IntervalSet.of(1,10);
        s.add(-3,-3);
        s.remove(5);
