...
public class TestLexerErrors extends BaseTest {
	...
	@Ignore @Test public void testEnforcedGreedyNestedBrances() {
		String grammar =
			"lexer grammar R;\n"
			+ "ACTION : '{' (ACTION | ~[{}])* '}';\n"
			+ "WS : [ \\r\\n\\t]+ -> skip;\n";
	...
	@Ignore @Test public void testInvalidCharAtStartAfterDFACache() throws Exception {
		String grammar =
			"lexer grammar L;\n" +
			"A : 'a' 'b' ;\n";
	...
	@Ignore @Test public void testInvalidCharInToken() throws Exception {
		String grammar =
			"lexer grammar L;\n" +
			"A : 'a' 'b' ;\n";
	...
	@Ignore @Test public void testInvalidCharInTokenAfterDFACache() throws Exception {
		String grammar =
			"lexer grammar L;\n" +
			"A : 'a' 'b' ;\n";
	...
	@Ignore @Test public void testDFAToATNThatFailsBackToDFA() throws Exception {
		String grammar =
			"lexer grammar L;\n" +
			"A : 'ab' ;\n"+
			"B : 'abc' ;\n";
	...
	@Ignore @Test public void testDFAToATNThatMatchesThenFailsInATN() throws Exception {
		String grammar =
			"lexer grammar L;\n" +
			"A : 'ab' ;\n"+
			"B : 'abc' ;\n"+
	...
	@Ignore @Test public void testErrorInMiddle() throws Exception {
		String grammar =
			"lexer grammar L;\n" +
			"A : 'abc' ;\n";
		String tokens = execLexer("L.g4", grammar, "L", "abx");
