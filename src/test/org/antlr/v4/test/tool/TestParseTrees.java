...
public class TestParseTrees extends BaseTest {
	...
	@Ignore @Test public void testToken2() throws Exception {
		String grammar =
			"grammar T;\n" +
			"s\n" +
			"@init {setBuildParseTree(true);}\n" +
	...
	@Ignore @Test public void test2Alts() throws Exception {
		String grammar =
			"grammar T;\n" +
			"s\n" +
			"@init {setBuildParseTree(true);}\n" +
	...
	@Ignore @Test public void test2AltLoop() throws Exception {
		String grammar =
			"grammar T;\n" +
			"s\n" +
			"@init {setBuildParseTree(true);}\n" +
	...
	@Ignore @Test public void testExtraToken() throws Exception {
		String grammar =
			"grammar T;\n" +
			"s\n" +
			"@init {setBuildParseTree(true);}\n" +
	...
	@Ignore @Test public void testNoViableAlt() throws Exception {
		String grammar =
			"grammar T;\n" +
			"s\n" +
			"@init {setBuildParseTree(true);}\n" +
	...
	@Ignore @Test public void testSync() throws Exception {
		String grammar =
			"grammar T;\n" +
			"s\n" +
			"@init {setBuildParseTree(true);}\n" +
