...
public class TestSemPredEvalParser extends BaseTest {
	...
	@Ignore @Test public void testSimpleValidate2() throws Exception {
		String grammar =
			"grammar T;\n" +
				"s : a a a;\n" +
				"a : {false}? ID  {System.out.println(\"alt 1\");}\n" +
	 ...
	 */
	@Ignore @Test public void testAtomWithClosureInTranslatedLRRule() throws Exception {
		String grammar =
			"grammar T;\n" +
			"start : e[0] EOF;\n" +
			"e[int _p]\n" +
	...
	@Ignore @Test public void testValidateInDFA() throws Exception {
		String grammar =
			"grammar T;\n" +
				"s : a ';' a;\n" +
	...
	@Ignore @Test public void testSimple() throws Exception {
		String grammar =
			"grammar T;\n" +
	...
	@Ignore @Test public void testOrder() throws Exception {
	...
	@Ignore @Test public void test2UnpredicatedAlts() throws Exception {
	...
	@Ignore @Test public void test2UnpredicatedAltsAndOneOrthogonalAlt() throws Exception {
		String grammar =
			"grammar T;\n" +
			"@header {" +
			"import java.util.*;" +
	...
	@Ignore @Test public void testRewindBeforePredEval() throws Exception {
	...
	@Ignore @Test public void testNoTruePredsThrowsNoViableAlt() throws Exception {
	...
	@Ignore @Test public void testToLeft() throws Exception {
		String grammar =
			"grammar T;\n" +
				"s : a+ ;\n" +
   			"a : {false}? ID {System.out.println(\"alt 1\");}\n" +
	...
	@Ignore @Test public void testActionHidesPreds() throws Exception {
	 ...
	 */
	@Ignore @Test public void testToLeftWithVaryingPredicate() throws Exception {
		String grammar =
			"grammar T;\n" +
	 ...
	 */
	@Ignore @Test public void testPredicateDependentOnArg() throws Exception {
		String grammar =
			"grammar T;\n" +
			"@parser::members {int i=0;}\n" +
			"s : a[2] a[1];\n" +
     ...
     */
    @Ignore @Test public void testPredicateDependentOnArg2() throws Exception {
        String grammar =
            "grammar T;\n" +
            "s : a[2] a[1];\n" +
            "a[int i]" +
    ...
    @Ignore @Test public void testDependentPredNotInOuterCtxShouldBeIgnored() throws Exception {
    ...
    @Ignore @Test public void testIndependentPredNotPassedOuterCtxToAvoidCastException() throws Exception {
        String grammar =
            "grammar T;\n" +
            "s : b ';' |  b '.' ;\n" +
            "b : a ;\n" +
     ...
     */
    @Ignore @Test public void testPredsInGlobalFOLLOW() throws Exception {
        String grammar =
        "grammar T;\n" +
        "@parser::members {" +
   	 ...
   	 */
   	@Ignore @Test public void testDepedentPredsInGlobalFOLLOW() throws Exception {
   		String grammar =
   			"grammar T;\n" +
   			"@parser::members {" +
   			"void f(Object s) {System.out.println(s);}\n" +
	 ...
	 */
	@Ignore @Test public void testActionsHidePredsInGlobalFOLLOW() throws Exception {
		String grammar =
			"grammar T;\n" +
			"@parser::members {" +
			"void f(Object s) {System.out.println(s);}\n" +
	...
	@Ignore @Test public void testPredTestedEvenWhenUnAmbig() throws Exception {
		String grammar =
			"grammar T;\n" +
			"\n" +
	 ...
	 */
	@Ignore @Test public void testDisabledAlternative() {
		String grammar =
	 ...
	 */
	@Ignore @Test public void testPredFromAltTestedInLoopBack() {
		String grammar =
			"grammar T2;\n" +
			"\n" +
			"file\n" +
