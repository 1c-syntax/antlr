...
public class TestLexerExec extends BaseTest {
    ...
    @Ignore @Test public void testRefToRuleDoesNotSetTokenNorEmitAnother() throws Exception {
   		String grammar =
   			"lexer grammar L;\n"+
   			"A : '-' I ;\n" +
   			"I : '0'..'9'+ ;\n"+
	...
	@Ignore @Test public void testSlashes() throws Exception {
		String grammar =
			"lexer grammar L;\n"+
			"Backslash : '\\\\';\n" +
			"Slash : '/';\n" +
	 ...
	 */
	@Ignore @Test public void testParentheses() {
		String grammar =
			"lexer grammar Demo;\n" +
			"\n" +
			"START_BLOCK: '-.-.-';\n" +
	...
	@Ignore @Test public void testActionPlacement() throws Exception {
		String grammar =
			"lexer grammar L;\n"+
	...
	@Ignore @Test public void testGreedyConfigs() throws Exception {
		String grammar =
			"lexer grammar L;\n"+
	...
	@Ignore @Test public void testNonGreedyConfigs() throws Exception {
		String grammar =
			"lexer grammar L;\n"+
			"I : .*? ('a' | 'ab') {System.out.println(getText());} ;\n"+
			"WS : (' '|'\\n') -> skip ;\n" +
	...
	@Ignore @Test public void testKeywordID() throws Exception {
		String grammar =
			"lexer grammar L;\n"+
			"KEND : 'end' ;\n" + // has priority
			"ID : 'a'..'z'+ ;\n" +
	...
	@Ignore @Test public void testHexVsID() throws Exception {
		String grammar =
			"lexer grammar L;\n"+
	...
	@Ignore @Test public void testCharSetPlus() throws Exception {
		String grammar =
			"lexer grammar L;\n"+
			"I : '0'..'9'+ {System.out.println(\"I\");} ;\n"+
			"WS : [ \\n\\u000D]+ -> skip ;";
	...
	@Ignore @Test public void testCharSetNot() throws Exception {
		String grammar =
			"lexer grammar L;\n"+
	...
	@Ignore @Test public void testCharSetInSet() throws Exception {
		String grammar =
			"lexer grammar L;\n"+
	...
	@Ignore @Test public void testCharSetWithMissingEndRange() throws Exception {
		String grammar =
			"lexer grammar L;\n"+
	...
	@Ignore @Test public void testCharSetWithMissingEscapeChar() throws Exception {
		String grammar =
			"lexer grammar L;\n"+
			"I : [0-9]+ {System.out.println(\"I\");} ;\n"+
			"WS : [ \\n]+ -> skip ;";
	...
	@Ignore @Test public void testCharSetWithEscapedChar() throws Exception {
		String grammar =
			"lexer grammar L;\n"+
	...
	@Ignore @Test public void testCharSetWithQuote() throws Exception {
		String grammar =
			"lexer grammar L;\n"+
	...
	@Ignore @Test public void testCharSetWithQuote2() throws Exception {
		String grammar =
			"lexer grammar L;\n"+
	 ...
	 */
	@Ignore @Test public void testZeroLengthToken() throws Exception {
		String grammar =
			"lexer grammar L;\n"+
			"\n" +
			"BeginString\n" +
