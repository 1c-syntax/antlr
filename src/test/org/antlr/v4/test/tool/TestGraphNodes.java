...
public class TestGraphNodes {
	...
	@Ignore @Test public void test_$_$_fullctx() {
	...
	@Ignore @Test public void test_x_$() {
	...
	@Ignore @Test public void test_x_$_fullctx() {
	...
	@Ignore @Test public void test_$_x() {
	...
	@Ignore @Test public void test_$_x_fullctx() {
	...
	@Ignore @Test public void test_a_a() {
	...
	@Ignore @Test public void test_a$_ax() {
	...
	@Ignore @Test public void test_a$_ax_fullctx() {
	...
	@Ignore @Test public void test_ax$_a$() {
		PredictionContext x = x(false);
	...
	@Ignore @Test public void test_aa$_a$_$_fullCtx() {
	...
	@Ignore @Test public void test_ax$_a$_fullctx() {
		PredictionContext x = x(true);
		PredictionContext a1 = createSingleton(x, 1);
	...
	@Ignore @Test public void test_a_b() {
	...
	@Ignore @Test public void test_ax_ax_same() {
		PredictionContext x = x(false);
		PredictionContext a1 = createSingleton(x, 1);
		PredictionContext a2 = createSingleton(x, 1);
		PredictionContext r = contextCache.join(a1, a2);
	...
	@Ignore @Test public void test_ax_ax() {
	...
	@Ignore @Test public void test_abx_abx() {
		PredictionContext x1 = x(false);
		PredictionContext x2 = x(false);
	...
	@Ignore @Test public void test_abx_acx() {
		PredictionContext x1 = x(false);
		PredictionContext x2 = x(false);
	...
	@Ignore @Test public void test_ax_bx_same() {
		PredictionContext x = x(false);
	...
	@Ignore @Test public void test_ax_bx() {
		PredictionContext x1 = x(false);
		PredictionContext x2 = x(false);
	...
	@Ignore @Test public void test_ax_by() {
	...
	@Ignore @Test public void test_a$_bx() {
		PredictionContext x2 = x(false);
	...
	@Ignore @Test public void test_a$_bx_fullctx() {
	...
	@Ignore @Test public void test_aex_bfx() {
		PredictionContext x1 = x(false);
		PredictionContext x2 = x(false);
	...
	@Ignore @Test public void test_A$_A$_fullctx() {
	...
	@Ignore @Test public void test_Aab_Ac() { // a,b + c
		PredictionContext a = a(false);
	...
	@Ignore @Test public void test_Aa_Aa() {
		PredictionContext a1 = a(false);
		PredictionContext a2 = a(false);
	...
	@Ignore @Test public void test_Aa_Abc() { // a + b,c
		PredictionContext a = a(false);
		PredictionContext b = b(false);
		PredictionContext c = c(false);
	...
	@Ignore @Test public void test_Aac_Ab() { // a,c + b
		PredictionContext a = a(false);
		PredictionContext b = b(false);
		PredictionContext c = c(false);
	...
	@Ignore @Test public void test_Aab_Aa() { // a,b + a
	...
	@Ignore @Test public void test_Aab_Ab() { // a,b + b
		PredictionContext A1 = array(a(false), b(false));
	...
	@Ignore @Test public void test_Aax_Aby() { // ax + by but in arrays
		PredictionContext a = createSingleton(x(false), 1);
		PredictionContext b = createSingleton(y(false), 2);
		PredictionContext A1 = array(a);
		PredictionContext A2 = array(b);
	...
	@Ignore @Test public void test_Aax_Aay() { // ax + ay -> merged singleton a, array parent
	...
	@Ignore @Test public void test_Aaxc_Aayd() { // ax,c + ay,d -> merged a, array parent
		PredictionContext a1 = createSingleton(x(false), 1);
		PredictionContext a2 = createSingleton(y(false), 1);
	...
	@Ignore @Test public void test_Aaubv_Acwdx() { // au,bv + cw,dx -> [a,b,c,d]->[u,v,w,x]
	...
	@Ignore @Test public void test_Aaubv_Abvdx() { // au,bv + bv,dx -> [a,b,d]->[u,v,x]
		PredictionContext a = createSingleton(u(false), 1);
	...
	@Ignore @Test public void test_Aaubv_Abwdx() { // au,bv + bw,dx -> [a,b,d]->[u,[v,w],x]
		PredictionContext a = createSingleton(u(false), 1);
		PredictionContext b1 = createSingleton(v(false), 2);
	...
	@Ignore @Test public void test_Aaubv_Abvdu() { // au,bv + bv,du -> [a,b,d]->[u,v,u]; u,v shared
		PredictionContext a = createSingleton(u(false), 1);
		PredictionContext b1 = createSingleton(v(false), 2);
		PredictionContext b2 = createSingleton(v(false), 2);
	...
	@Ignore @Test public void test_Aaubu_Acudu() { // au,bu + cu,du -> [a,b,c,d]->[u,u,u,u]
		PredictionContext a = createSingleton(u(false), 1);
