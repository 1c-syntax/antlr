...
public class TestFastQueue {
    ...
    @Ignore @Test public void testQueueThenRemoveAll() throws Exception {
        FastQueue<String> q = new FastQueue<String>();
        q.add("a");
        q.add("b");
        q.add("c");
    ...
    @Ignore @Test public void testQueueThenRemoveOneByOne() throws Exception {
        StringBuilder buf = new StringBuilder();
        FastQueue<String> q = new FastQueue<String>();
        q.add("a");
        buf.append(q.remove());
    ...
    @Ignore @Test public void testGetFromEmptyQueue() throws Exception {
        FastQueue<String> q = new FastQueue<String>();
        String msg = null;
        try { q.remove(); }
    ...
    @Ignore @Test public void testGetFromEmptyQueueAfterSomeAdds() throws Exception {
        FastQueue<String> q = new FastQueue<String>();
        q.add("a");
        q.add("b");
        q.remove();
    ...
    @Ignore @Test public void testGetFromEmptyQueueAfterClear() throws Exception {
        FastQueue<String> q = new FastQueue<String>();
        q.add("a");
        q.add("b");
        q.clear();
