...
public class TestLeftRecursionToolIssues extends BaseTest {
	 ...
	 */
	@Ignore @Test public void testDirectCallToLeftRecursiveRule() throws Exception {
		String grammar =
			"grammar T;\n" +
	...
	@Ignore @Test public void testSemPred() throws Exception {
		String grammar =
			"grammar T;\n" +
			"s @after {System.out.println($ctx.toStringTree(this));} : a ;\n" +
			"a : a {true}? ID\n" +
	...
	@Ignore @Test public void testTernaryExpr() throws Exception {
		String grammar =
			"grammar T;\n" +
	 ...
	 */
	@Ignore @Test public void testTernaryExprExplicitAssociativity() throws Exception {
		String grammar =
			"grammar T;\n" +
			"s @after {System.out.println($ctx.toStringTree(this));} : e EOF ;\n" + // must indicate EOF can follow or 'a<EOF>' won't match
			"e :<assoc=right> e '*' e" +
	...
	@Ignore @Test public void testExpressions() throws Exception {
		String grammar =
			"grammar T;\n" +
	...
	@Ignore @Test public void testJavaExpressions() throws Exception {
	...
	@Ignore @Test public void testDeclarations() throws Exception {
		String grammar =
			"grammar T;\n" +
	...
	@Ignore @Test public void testReturnValueAndActions() throws Exception {
		String grammar =
			"grammar T;\n" +
	 ...
	 */
	@Ignore @Test public void testReturnValueAndActionsList1() throws Exception {
		String grammar =
			"grammar T;\n" +
	 ...
	 */
	@Ignore @Test public void testReturnValueAndActionsList2() throws Exception {
		String grammar =
			"grammar T;\n" +
			"s @after {System.out.println($ctx.toStringTree(this));} : expr EOF;\n" +
			"expr:\n" +
	...
	@Ignore @Test public void testLabelsOnOpSubrule() throws Exception {
		String grammar =
			"grammar T;\n" +
	...
	@Ignore @Test public void testReturnValueAndActionsAndLabels() throws Exception {
		String grammar =
			"grammar T;\n" +
	 ...
	 */
	@Ignore @Test public void testMultipleAlternativesWithCommonLabel() throws Exception {
		String grammar =
			"grammar T;\n" +
			"s : e {System.out.println($e.v);} ;\n" +
			"\n" +
	...
	@Ignore @Test public void testPrefixOpWithActionAndLabel() throws Exception {
		String grammar =
			"grammar T;\n" +
	...
	@Ignore @Test public void testCheckForNonLeftRecursiveRule() throws Exception {
		String grammar =
			"grammar T;\n" +
			"s @after {System.out.println($ctx.toStringTree(this));} : a ;\n" +
			"a : a ID\n" +
	...
	@Ignore @Test public void testCheckForLeftRecursiveEmptyFollow() throws Exception {
		String grammar =
			"grammar T;\n" +
			"s @after {System.out.println($ctx.toStringTree(this));} : a ;\n" +
			"a : a ID?\n" +
	 ...
	 */
	@Ignore @Test public void testWhitespaceInfluence() {
		String grammar =
			"grammar Expr;\n" +
			"prog : expression EOF;\n" +
			"expression\n" +
	 ...
	 */
	@Ignore @Test public void testPrecedenceFilterConsidersContext() throws Exception {
		String grammar =
			"grammar T;\n" +
			"prog\n" +
	 ...
	 */
	@Ignore @Test public void testMultipleActions() throws Exception {
		String grammar =
			"grammar T;\n" +
			"s @after {System.out.println($ctx.toStringTree(this));} : e ;\n" +
			"e : a=e op=('*'|'/') b=e  {}{}\n" +
	 ...
	 * https://github.com/antlr/antlr4/issues/625
	 */
	@Ignore @Test public void testMultipleActionsPredicatesOptions() throws Exception {
		String grammar =
			"grammar T;\n" +
			"s @after {System.out.println($ctx.toStringTree(this));} : e ;\n" +
			"e : a=e op=('*'|'/') b=e  {}{true}?\n" +
