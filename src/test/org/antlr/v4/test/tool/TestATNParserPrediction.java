...
public class TestATNParserPrediction extends BaseTest {
	...
	@Ignore @Test public void testRuleRefxory() throws Exception {
		LexerGrammar lg = new LexerGrammar(
			"lexer grammar L;\n" +
			"A : 'a' ;\n" +
			"B : 'b' ;\n" +
	...
	@Ignore @Test public void testOptionalRuleChasesGlobalFollow() throws Exception {
		LexerGrammar lg = new LexerGrammar(
			"lexer grammar L;\n" +
			"A : 'a' ;\n" +
			"B : 'b' ;\n" +
	...
	@Ignore @Test public void testLL1Ambig() throws Exception {
		LexerGrammar lg = new LexerGrammar(
			"lexer grammar L;\n" +
			"A : 'a' ;\n" +
			"B : 'b' ;\n" +
	...
	@Ignore @Test public void testLL2Ambig() throws Exception {
		LexerGrammar lg = new LexerGrammar(
			"lexer grammar L;\n" +
			"A : 'a' ;\n" +
			"B : 'b' ;\n" +
	...
	@Ignore @Test public void testRecursiveLeftPrefixWithAorABIssue() throws Exception {
		LexerGrammar lg = new LexerGrammar(
			"lexer grammar L;\n" +
			"A : 'a' ;\n" +
			"B : 'b' ;\n" +
	...
	@Ignore @Test public void testContinuePrediction() throws Exception {
	...
	@Ignore @Test public void testContinuePrediction2() throws Exception {
	...
	@Ignore @Test public void testAltsForLRRuleComputation() throws Exception {
		Grammar g = new Grammar(
		"grammar T;\n" +
		"e : e '*' e\n" +
		"  | INT\n" +
	...
	@Ignore @Test public void testAltsForLRRuleComputation2() throws Exception {
		Grammar g = new Grammar(
		"grammar T;\n" +
		"e : INT\n" +
		"  | e '*' e\n" +
	...
	@Ignore @Test public void testAltsForLRRuleComputation3() throws Exception {
		Grammar g = new Grammar(
		"grammar T;\n" +
