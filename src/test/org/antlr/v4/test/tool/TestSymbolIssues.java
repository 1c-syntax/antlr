...
public class TestSymbolIssues extends BaseTest {
    ...
    @Ignore @Test public void testB() { super.testErrors(B, false); }
	@Ignore @Test public void testD() { super.testErrors(D, false); }
	@Ignore @Test public void testE() { super.testErrors(E, false); }
	@Ignore @Test public void testF() { super.testErrors(F, false); }

	@Ignore @Test public void testStringLiteralRedefs() throws Exception {
		String grammar =
			"lexer grammar L;\n" +
			"A : 'a' ;\n" +
			"mode X;\n"+
	...
	@Ignore @Test public void testEmptyLexerModeDetection() throws Exception {
		String[] test = {
			"lexer grammar L;\n" +
			"A : 'a';\n" +
			"mode X;\n" +
	...
	@Ignore @Test public void testEmptyLexerRuleDetection() throws Exception {
		String[] test = {
			"lexer grammar L;\n" +
			"A : 'a';\n" +
			"WS : [ \t]* -> skip;\n" +
	...
	@Ignore @Test public void testTokensModesChannelsDeclarationConflictsWithReserved() throws Exception {
		String[] test = {
			"lexer grammar L;\n" +
	...
	@Ignore @Test public void testTokensModesChannelsUsingConflictsWithReserved() throws Exception {
		String[] test = {
			"lexer grammar L;\n" +
			"A: 'a' -> channel(SKIP);\n" +
			"B: 'b' -> type(MORE);\n" +
	...
	@Ignore @Test public void testWrongIdForTypeChannelModeCommand() throws Exception {
		String[] test = {
			"lexer grammar L;\n" +
			"tokens { TOKEN1 }\n" +
			"channels { CHANNEL1 }\n" +
	...
	@Ignore @Test public void testDuplicatedCommands() throws Exception {
		String[] test = {
			"lexer grammar Lexer;\n" +
	...
	// https://github.com/antlr/antlr4/issues/1388
	@Ignore @Test public void testIncompatibleCommands() throws Exception {
		String[] test = {
				"lexer grammar L;\n" +
				"channels { CHANNEL1 }\n" +
				"tokens { TYPE1 }\n" +
	...
	@Ignore @Test public void testLabelsForTokensWithMixedTypes() {
		String[] test = {
				"grammar L;\n" +
				"\n" +
	...
	@Ignore @Test public void testLabelsForTokensWithMixedTypesLRWithLabels() {
		String[] test = {
				"grammar L;\n" +
				"\n" +
				"expr\n" +
	...
	@Ignore @Test public void testCharsCollision() throws  Exception {
		String[] test = {
				"lexer grammar L;\n" +
				"TOKEN_RANGE:      [aa-f];\n" +
	...
	@Ignore @Test public void testUnreachableTokens() {
		String[] test = {
				"lexer grammar Test;\n" +
				"TOKEN1: 'as' 'df' | 'qwer';\n" +
				"TOKEN2: [0-9];\n" +
