...
public class TestCompositeGrammars extends BaseTest {
	...
	@Ignore @Test public void testImportSelfLoop() throws Exception {
		mkdir(tmpdir);
		String master =
			"grammar M;\n" +
			"import M;\n" +
	...
	@Ignore @Test public void testErrorInImportedGetsRightFilename() throws Exception {
		String slave =
			"parser grammar S;\n" +
			"a : 'a' | c;\n";
		mkdir(tmpdir);
	...
	@Ignore @Test public void testImportFileNotSearchedForInOutputDir() throws Exception {
		String slave =
			"parser grammar S;\n" +
			"a : B {System.out.println(\"S.a\");} ;\n";
		mkdir(tmpdir);
	...
	@Ignore @Test public void testOutputDirShouldNotEffectImports() throws Exception {
		String slave =
			"parser grammar S;\n" +
			"a : B {System.out.println(\"S.a\");} ;\n";
		mkdir(tmpdir);
	...
	@Ignore @Test public void testTokensFileInOutputDirAndImportFileInSubdir() throws Exception {
		String slave =
			"parser grammar S;\n" +
			"a : B {System.out.println(\"S.a\");} ;\n";
		mkdir(tmpdir);
	...
	@Ignore @Test public void testDelegatorInvokesDelegateRule() throws Exception {
		String slave =
			"parser grammar S;\n" +
			"a : B {System.out.println(\"S.a\");} ;\n";
		mkdir(tmpdir);
	...
	@Ignore @Test public void testBringInLiteralsFromDelegate() throws Exception {
		String slave =
			"parser grammar S;\n" +
	...
	@Ignore @Test public void testDelegatorInvokesDelegateRuleWithArgs() throws Exception {
	...
	@Ignore @Test public void testDelegatorInvokesDelegateRuleWithReturnStruct() throws Exception {
		// must generate something like:
		// public int a(int x) throws RecognitionException { return gS.a(x); }
		// in M.
		String slave =
	...
	@Ignore @Test public void testDelegatorAccessesDelegateMembers() throws Exception {
		String slave =
			"parser grammar S;\n" +
			"@parser::members {\n" +
	...
	@Ignore @Test public void testDelegatorInvokesFirstVersionOfDelegateRule() throws Exception {
		String slave =
			"parser grammar S;\n" +
			"a : b {System.out.println(\"S.a\");} ;\n" +
			"b : B ;\n" ;
	...
	@Ignore @Test public void testDelegatesSeeSameTokenType() throws Exception {
		String slave =
	...
	@Ignore @Test public void testDelegatesSeeSameTokenType2() throws Exception {
	...
	@Ignore @Test public void testCombinedImportsCombined() throws Exception {
		ErrorQueue equeue = new ErrorQueue();
		String slave =
			"grammar S;\n" + // A, B, C token type order
			"tokens { A, B, C }\n" +
	...
	@Ignore @Test public void testImportedTokenVocabIgnoredWithWarning() throws Exception {
		ErrorQueue equeue = new ErrorQueue();
		String slave =
			"parser grammar S;\n" +
	...
	@Ignore @Test public void testSyntaxErrorsInImportsNotThrownOut() throws Exception {
		ErrorQueue equeue = new ErrorQueue();
		String slave =
			"parser grammar S;\n" +
			"options {toke\n";
	...
	@Ignore @Test public void testDelegatorRuleOverridesDelegate() throws Exception {
		String slave =
			"parser grammar S;\n" +
			"a : b {System.out.println(\"S.a\");} ;\n" +
			"b : B ;\n" ;
	...
	@Ignore @Test public void testDelegatorRuleOverridesLookaheadInDelegate() throws Exception {
		String slave =
    ...
    @Ignore @Test public void testDelegatorRuleOverridesDelegates() throws Exception {
        String slave =
            "parser grammar S;\n" +
            "a : b {System.out.println(\"S.a\");} ;\n" +
            "b : 'b' ;\n" ;
	...
	@Ignore @Test public void testLexerDelegatorInvokesDelegateRule() throws Exception {
		String slave =
			"lexer grammar S;\n" +
			"A : 'a' {System.out.println(\"S.A\");} ;\n" +
			"C : 'c' ;\n";
	...
	@Ignore @Test public void testLexerDelegatorRuleOverridesDelegate() throws Exception {
		String slave =
			"lexer grammar S;\n" +
			"A : 'a' {System.out.println(\"S.A\");} ;\n" +
	...
	@Ignore @Test public void testKeywordVSIDOrder() throws Exception {
	...
	@Ignore @Test public void test3LevelImport() throws Exception {
		ErrorQueue equeue = new ErrorQueue();
		String slave =
			"parser grammar T;\n" +
			"a : T ;\n" ;
	...
	@Ignore @Test public void testBigTreeOfImports() throws Exception {
		ErrorQueue equeue = new ErrorQueue();
		String slave =
			"parser grammar T;\n" +
			"tokens{T}\n" +
	...
	@Ignore @Test public void testRulesVisibleThroughMultilevelImport() throws Exception {
		ErrorQueue equeue = new ErrorQueue();
		String slave =
			"parser grammar T;\n" +
			"x : T ;\n" ;
	...
	@Ignore @Test public void testNestedComposite() throws Exception {
	...
	@Ignore @Test public void testHeadersPropogatedCorrectlyToImportedGrammars() throws Exception {
		String slave =
			"parser grammar S;\n" +
			"a : B {System.out.print(\"S.a\");} ;\n";
		mkdir(tmpdir);
	...
	@Ignore @Test public void testImportedRuleWithAction() throws Exception {
	...
	@Ignore @Test public void testImportedGrammarWithEmptyOptions() throws Exception {
		String slave =
			"parser grammar S;\n" +
			"options {}\n" +
			"a : B ;\n";
	 ...
	 */
	@Ignore @Test public void testImportLexerWithOnlyFragmentRules() {
		String slave =
