...
public class TestUnbufferedCharStream extends BaseTest {
	@Ignore @Test public void testNoChar() throws Exception {
	...
	@Ignore @Test public void test1Char() throws Exception {
	...
	@Ignore @Test public void test2Char() throws Exception {
    ...
    @Ignore @Test public void test2CharAhead() throws Exception {
    ...
    @Ignore @Test public void testBufferExpand() throws Exception {
    ...
    @Ignore @Test public void testBufferWrapSize1() throws Exception {
    ...
    @Ignore @Test public void testBufferWrapSize2() throws Exception {
	...
	@Ignore @Test public void test1Mark() throws Exception {
	...
	@Ignore @Test public void test1MarkWithConsumesInSequence() throws Exception {
		TestingUnbufferedCharStream input = createStream("xyz");
		int m = input.mark();
    ...
    @Ignore @Test public void test2Mark() throws Exception {
    ...
    @Ignore @Test public void testAFewTokens() throws Exception {
