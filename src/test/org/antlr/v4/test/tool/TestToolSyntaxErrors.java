...
public class TestToolSyntaxErrors extends BaseTest {
	...
	@Ignore @Test public void testA() { super.testErrors(A, true); }

	@Ignore @Test public void testExtraColon() {
	...
	@Ignore @Test public void testMissingRuleSemi() {
		String[] pair = new String[] {
			"grammar A;\n" +
			"a : A \n" +
			"b : B ;",
	...
	@Ignore @Test public void testMissingRuleSemi2() {
		String[] pair = new String[] {
			"lexer grammar A;\n" +
			"A : 'a' \n" +
			"B : 'b' ;",
	...
	@Ignore @Test public void testMissingRuleSemi3() {
		String[] pair = new String[] {
			"grammar A;\n" +
			"a : A \n" +
	...
	@Ignore @Test public void testMissingRuleSemi4() {
		String[] pair = new String[] {
			"grammar A;\n" +
			"a : b \n" +
			"  catch [Exception e] {...}\n" +
	...
	@Ignore @Test public void testMissingRuleSemi5() {
		String[] pair = new String[] {
			"grammar A;\n" +
			"a : A \n" +
			"  catch [Exception e] {...}\n",
	...
	@Ignore @Test public void testBadRulePrequelStart() {
		String[] pair = new String[] {
			"grammar A;\n" +
			"a @ options {k=1;} : A ;\n" +
			"b : B ;",
	...
	@Ignore @Test public void testBadRulePrequelStart2() {
		String[] pair = new String[] {
			"grammar A;\n" +
			"a } : A ;\n" +
			"b : B ;",
	...
	@Ignore @Test public void testModeInParser() {
		String[] pair = new String[] {
			"grammar A;\n" +
			"a : A ;\n" +
			"mode foo;\n" +
	 ...
	 */
	@Ignore @Test public void testUnterminatedStringLiteral() {
		String[] pair = new String[] {
			"grammar A;\n" +
			"a : 'x\n" +
			"  ;\n",
	 ...
	 */
	@Ignore @Test public void testParserRuleNameStartingWithUnderscore() {
		String[] pair = new String[] {
			"grammar A;\n" +
			"_a : 'x' ;\n",
	 ...
	 */
	@Ignore @Test public void testEmptyGrammarOptions() {
		String[] pair = new String[] {
			"grammar A;\n" +
			"options {}\n" +
			"a : 'x' ;\n",
	 ...
	 * https://github.com/antlr/antlr4/issues/194
	 */
	@Ignore @Test public void testEmptyRuleOptions() {
		String[] pair = new String[] {
			"grammar A;\n" +
			"a options{} : 'x' ;\n",
	 ...
	 * https://github.com/antlr/antlr4/issues/194
	 */
	@Ignore @Test public void testEmptyBlockOptions() {
		String[] pair = new String[] {
			"grammar A;\n" +
			"a : (options{} : 'x') ;\n",
	...
	@Ignore @Test public void testEmptyTokensBlock() {
		String[] pair = new String[] {
			"grammar A;\n" +
			"tokens {}\n" +
			"a : 'x' ;\n",
	 ...
	 */
	@Ignore @Test public void testInvalidLexerCommand() {
		String[] pair = new String[] {
			"grammar A;\n" +
			"tokens{Foo}\n" +
			"b : Foo ;\n" +
	...
	@Ignore @Test public void testLexerCommandArgumentValidation() {
		String[] pair = new String[] {
			"grammar A;\n" +
			"tokens{Foo}\n" +
			"b : Foo ;\n" +
	...
	@Ignore @Test public void testRuleRedefinition() {
		String[] pair = new String[] {
			"grammar Oops;\n" +
			"\n" +
			"ret_ty : A ;\n" +
	...
	@Ignore @Test public void testEpsilonClosureAnalysis() {
		String grammar =
			"grammar A;\n"
			+ "x : ;\n"
			+ "y1 : x+;\n"
	...
	@Ignore @Test public void testEpsilonNestedClosureAnalysis() {
		String grammar =
			"grammar T;\n"+
			"s : (a a)* ;\n"+
			"a : 'foo'* ;\n";
	...
	// Test for https://github.com/antlr/antlr4/issues/1203
	@Ignore @Test public void testEpsilonOptionalAndClosureAnalysis() {
		String grammar =
			"grammar T;\n"+
			"s : (a a)? ;\n"+
			"a : 'foo'* ;\n";
	...
	@Ignore @Test public void testEpsilonOptionalAnalysis() {
		String grammar =
			"grammar A;\n"
			+ "x : ;\n"
			+ "y  : x?;\n"
	 ...
	 */
	@Ignore @Test public void testActionAtEndOfOneLexerAlternative() {
		String grammar =
			"grammar A;\n" +
	 ...
	 */
	@Ignore @Test public void testDoubleQuotedStringLiteral() {
		String grammar =
			"lexer grammar A;\n"
			+ "WHITESPACE : (\" \" | \"\\t\" | \"\\n\" | \"\\r\" | \"\\f\");\n";
		String expected =
	 ...
	 */
	@Ignore @Test public void testDoubleQuoteInTwoStringLiterals() {
		String grammar =
			"lexer grammar A;\n" +
			"STRING : '\\\"' '\\\"' 'x' ;";
		String expected =
	 ...
	 */
	@Ignore @Test public void testValidEscapeSequences() {
		String grammar =
			"lexer grammar A;\n" +
			"NORMAL_ESCAPE : '\\b \\t \\n \\f \\r \\' \\\\';\n" +
			"UNICODE_ESCAPE : '\\u0001 \\u00A1 \\u00a1 \\uaaaa \\uAAAA';\n";
	 ...
	 */
	@Ignore @Test public void testInvalidEscapeSequences() {
		String grammar =
			"lexer grammar A;\n" +
			"RULE : 'Foo \\uAABG \\x \\u';\n";
		String expected =
	 ...
	 */
	@Ignore @Test public void testNotAllowedEmptyStrings() {
		String grammar =
			"lexer grammar T;\n" +
			"Error0: '''test''';\n" +
			"Error1: '' 'test';\n" +
	...
	@Ignore @Test public void testInvalidCharSetsAndStringLiterals() {
		String grammar =
				"lexer grammar Test;\n" +
	...
	@Ignore @Test public void testInvalidUnicodeEscapesInCharSet() {
		String grammar =
				"lexer grammar Test;\n" +
	 ...
	 */
	@Ignore @Test public void testUnrecognizedAssocOption() {
		String grammar =
			"grammar A;\n" +
			"x : 'x'\n" +
	 ...
	 * is produced as described in the documentation.
	 */
	@Ignore @Test public void testFragmentActionIgnored() {
		String grammar =
			"lexer grammar A;\n" +
			"X1 : 'x' -> more    // ok\n" +
			"   ;\n" +
	 ...
	 */
	@Ignore @Test public void testTokenNamedEOF() {
		String grammar =
			"lexer grammar A;\n" +
			"WS : ' ';\n" +
			" EOF : 'a';\n";
	 ...
	 */
	@Ignore @Test public void testInvalidLanguageInGrammar() throws Exception {
		String grammar =
			"grammar T;\n" +
	 ...
	 * https://github.com/antlr/antlr4/issues/649
	 */
	@Ignore @Test public void testInvalidLanguageInGrammarWithLexerCommand() throws Exception {
		String grammar =
			"grammar T;\n" +
			"options { language=Foo; }\n" +
			"start : 'T' EOF;\n" +
	...
	@Ignore @Test public void testChannelDefinitionInLexer() throws Exception {
		String grammar =
			"lexer grammar T;\n" +
			"\n" +
			"channels {\n" +
	...
	@Ignore @Test public void testChannelDefinitionInParser() throws Exception {
		String grammar =
			"parser grammar T;\n" +
			"\n" +
			"channels {\n" +
	...
	@Ignore @Test public void testChannelDefinitionInCombined() throws Exception {
		String grammar =
			"grammar T;\n" +
			"\n" +
			"channels {\n" +
	 ...
	 */
	@Ignore @Test public void testChannelDefinitions() throws Exception {
		String grammar =
			"lexer grammar T;\n" +
			"\n" +
			"channels {\n" +
	 ...
	 * not.</p>
	 */
	@Ignore @Test public void testRuleWithTooFewAltLabelsGroup() throws Exception {
		String grammar =
			"grammar T;\n" +
			"tokens { Foo1, Foo2 }\n" +
	 ...
	 */
	@Ignore @Test public void testRuleWithTooFewAltLabelsGroupSuppressed() throws Exception {
		String grammar =
			"grammar T;\n" +
			"tokens { Foo1, Foo2 }\n" +
			"start options { baseContext = start2; }\n" +
	 ...
	 */
	@Ignore @Test public void testBaseContextMustBeRuleName() throws Exception {
		String grammar =
			"grammar T;\n" +
			"tokens { Foo1, Foo2 }\n" +
			"start options { baseContext = start2; }\n" +
	 ...
	 */
	@Ignore @Test public void testBaseContextCannotBeTransitive() throws Exception {
		String grammar =
			"grammar T;\n" +
			"tokens { Foo1, Foo2 }\n" +
			"start options { baseContext = start2; }\n" +
	 ...
	 */
	@Ignore @Test public void testBaseContextCannotBeTransitive_Self() throws Exception {
		String grammar =
			"grammar T;\n" +
			"tokens { Foo1 }\n" +
	...
	@Ignore @Test public void testRangeInParserGrammar() {
		String grammar =
			"grammar T;\n"+
			"a:  'A'..'Z' ;\n";
		String expected =
