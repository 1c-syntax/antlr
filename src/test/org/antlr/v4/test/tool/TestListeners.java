...
public class TestListeners extends BaseTest {
	...
	@Ignore @Test public void testTokenGetters() throws Exception {
		String grammar =
			"grammar T;\n" +
			"@parser::members {\n" +
			"public static class LeafListener extends TBaseListener {\n" +
	...
	@Ignore @Test public void testRuleGetters() throws Exception {
		String grammar =
			"grammar T;\n" +
			"@parser::members {\n" +
			"public static class LeafListener extends TBaseListener {\n" +
	...
	@Ignore @Test public void testLR() throws Exception {
		String grammar =
			"grammar T;\n" +
			"@parser::members {\n" +
			"public static class LeafListener extends TBaseListener {\n" +
	...
	@Ignore @Test public void testLRWithLabels() throws Exception {
		String grammar =
			"grammar T;\n" +
			"@parser::members {\n" +
			"  public static class LeafListener extends TBaseListener {\n" +
