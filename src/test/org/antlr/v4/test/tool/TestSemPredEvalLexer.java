...
public class TestSemPredEvalLexer extends BaseTest {
	...
	@Ignore @Test public void testIDnotEnum() throws Exception {
		String grammar =
			"lexer grammar L;\n"+
			"ENUM : [a-z]+ {false}? ;\n" +
			"ID   : [a-z]+ ;\n"+
	...
	@Ignore @Test public void testEnumNotID() throws Exception {
		String grammar =
			"lexer grammar L;\n"+
	...
	@Ignore @Test public void testIndent() throws Exception {
		String grammar =
			"lexer grammar L;\n"+
			"ID : [a-z]+ ;\n"+
	...
	@Ignore @Test public void testLexerInputPositionSensitivePredicates() throws Exception {
		String grammar =
			"lexer grammar L;\n"+
	...
	@Ignore @Test public void testPredicatedKeywords() {
		String grammar =
			"lexer grammar A;" +
