...
class TagChunk extends Chunk {
  ...
  /**
   * Construct a new instance of {@link TagChunk} using the specified tag and no label.
   *
   * @param tag The tag, which should be the name of a parser rule or token type.
   *
   * @throws IllegalArgumentException if {@code tag} is {@code null} or empty.
   */
  ...
  /**
   * Construct a new instance of {@link TagChunk} using the specified label and tag.
   *
  ...
  /**
   * This method returns a text representation of the tag chunk. Labeled tags are returned in the form
   * {@code label:tag}, and unlabeled tags are returned as just the tag name.
   */
  @Override
