...
/**
 * An interface to access the tree of {@link RuleContext} objects created during a parse that makes the data structure
 * look like a simple parse tree. This node represents both internal nodes, rule invocations, and leaf nodes, token
 * matches.
 *
...
public interface ParseTree extends SyntaxTree {
   ...
   * and comments if they are sent to parser on hidden channel.
   */
  String getText();
