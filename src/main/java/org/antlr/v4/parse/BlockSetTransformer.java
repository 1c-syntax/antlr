 ...
 */
// $ANTLR 3.5.3 org/antlr/v4/parse/BlockSetTransformer.g 2025-02-05 09:25:54
...
public class BlockSetTransformer extends TreeRewriter {
      ...
      switch (alt3) {
          ...
          // org/antlr/v4/parse/BlockSetTransformer.g:40:7: ^( RULE (id= TOKEN_REF |id= RULE_REF ) ( . )+ )
        {
          _last = (GrammarAST) input.LT(1);
          {
            ...
            _last = (GrammarAST) input.LT(1);
            RULE1 = (GrammarAST) match(input, RULE, FOLLOW_RULE_in_topdown86);
            ...
            switch (alt1) {
              ...
              {
                _last = (GrammarAST) input.LT(1);
                id = (GrammarAST) match(input, TOKEN_REF, FOLLOW_TOKEN_REF_in_topdown91);
                if (state.failed) return retval;
              ...
              {
                _last = (GrammarAST) input.LT(1);
                id = (GrammarAST) match(input, RULE_REF, FOLLOW_RULE_REF_in_topdown95);
                if (state.failed) return retval;
  ...
  public final BlockSetTransformer.setAlt_return setAlt() throws RecognitionException {
    ...
    try {
      ...
      // org/antlr/v4/parse/BlockSetTransformer.g:47:4: {...}? ALT
      {
        ...
        _last = (GrammarAST) input.LT(1);
        ALT6 = (GrammarAST) match(input, ALT, FOLLOW_ALT_in_setAlt141);
        if (state.failed) return retval;
  ...
  public final BlockSetTransformer.ebnfSuffix_return ebnfSuffix() throws RecognitionException {
    ...
    try {
      ...
      if (state.backtracking == 1) {
        retval.tree = (GrammarAST) adaptor.dupNode(((GrammarAST) retval.start));
      }
    } catch (RecognitionException re) {
      reportError(re);
      recover(input, re);
      ...
      switch (alt10) {
          ...
          // org/antlr/v4/parse/BlockSetTransformer.g:73:4: {...}? ^( BLOCK ^(alt= ALT ( elementOptions )? {...}? setElement[inLexer] ) ( ^( ALT ( elementOptions )? setElement[inLexer] ) )+ )
        {
          ...
          _last = (GrammarAST) input.LT(1);
          {
            ...
            GrammarAST _first_1 = null;
            _last = (GrammarAST) input.LT(1);
            BLOCK10 = (GrammarAST) match(input, BLOCK, FOLLOW_BLOCK_in_blockSet244);
            if (state.failed) return retval;
            ...
            _last = (GrammarAST) input.LT(1);
            {
              ...
              _last = (GrammarAST) input.LT(1);
              alt = (GrammarAST) match(input, ALT, FOLLOW_ALT_in_blockSet249);
              if (state.failed) return retval;
              ...
              switch (alt6) {
                  ...
                  // org/antlr/v4/parse/BlockSetTransformer.g:74:93: ^( ALT ( elementOptions )? setElement[inLexer] )
                {
                  _last = (GrammarAST) input.LT(1);
                  {
                    ...
                    GrammarAST _first_2 = null;
                    _last = (GrammarAST) input.LT(1);
                    ALT13 = (GrammarAST) match(input, ALT, FOLLOW_ALT_in_blockSet263);
                    if (state.failed) return retval;
          ...
          // org/antlr/v4/parse/BlockSetTransformer.g:76:4: {...}? ^( BLOCK ^( ALT ( elementOptions )? setElement[inLexer] ) ( ^( ALT ( elementOptions )? setElement[inLexer] ) )+ )
        {
          ...
          _last = (GrammarAST) input.LT(1);
          {
            ...
            GrammarAST _first_1 = null;
            _last = (GrammarAST) input.LT(1);
            BLOCK16 = (GrammarAST) match(input, BLOCK, FOLLOW_BLOCK_in_blockSet313);
            if (state.failed) return retval;
            ...
            _last = (GrammarAST) input.LT(1);
            {
              ...
              GrammarAST _first_2 = null;
              _last = (GrammarAST) input.LT(1);
              ALT17 = (GrammarAST) match(input, ALT, FOLLOW_ALT_in_blockSet316);
              if (state.failed) return retval;
              ...
              switch (alt9) {
                  ...
                  // org/antlr/v4/parse/BlockSetTransformer.g:77:56: ^( ALT ( elementOptions )? setElement[inLexer] )
                {
                  _last = (GrammarAST) input.LT(1);
                  {
                    ...
                    GrammarAST _first_2 = null;
                    _last = (GrammarAST) input.LT(1);
                    ALT20 = (GrammarAST) match(input, ALT, FOLLOW_ALT_in_blockSet328);
                    if (state.failed) return retval;
        ...
        switch (alt11) {
            ...
            // org/antlr/v4/parse/BlockSetTransformer.g:85:6: ^(a= STRING_LITERAL elementOptions ) {...}?
          {
            _last = (GrammarAST) input.LT(1);
            {
              ...
              GrammarAST _first_1 = null;
              _last = (GrammarAST) input.LT(1);
              a = (GrammarAST) match(input, STRING_LITERAL, FOLLOW_STRING_LITERAL_in_setElement373);
              if (state.failed) return retval;
          ...
          {
            _last = (GrammarAST) input.LT(1);
            a = (GrammarAST) match(input, STRING_LITERAL, FOLLOW_STRING_LITERAL_in_setElement388);
            if (state.failed) return retval;
            ...
            // org/antlr/v4/parse/BlockSetTransformer.g:87:5: {...}? => ^( TOKEN_REF elementOptions )
          {
            ...
            _last = (GrammarAST) input.LT(1);
            {
              ...
              GrammarAST _first_1 = null;
              _last = (GrammarAST) input.LT(1);
              TOKEN_REF24 = (GrammarAST) match(input, TOKEN_REF, FOLLOW_TOKEN_REF_in_setElement400);
              if (state.failed) return retval;
            ...
            // org/antlr/v4/parse/BlockSetTransformer.g:88:5: {...}? => TOKEN_REF
          {
            ...
            _last = (GrammarAST) input.LT(1);
            TOKEN_REF26 = (GrammarAST) match(input, TOKEN_REF, FOLLOW_TOKEN_REF_in_setElement414);
            if (state.failed) return retval;
            ...
            // org/antlr/v4/parse/BlockSetTransformer.g:89:5: {...}? => ^( RANGE a= STRING_LITERAL b= STRING_LITERAL ) {...}?
          {
            ...
            _last = (GrammarAST) input.LT(1);
            {
              ...
              GrammarAST _first_1 = null;
              _last = (GrammarAST) input.LT(1);
              RANGE27 = (GrammarAST) match(input, RANGE, FOLLOW_RANGE_in_setElement425);
              if (state.failed) return retval;
              ...
              if (state.failed) return retval;
              _last = (GrammarAST) input.LT(1);
              a = (GrammarAST) match(input, STRING_LITERAL, FOLLOW_STRING_LITERAL_in_setElement429);
              if (state.failed) return retval;
              ...
              _last = (GrammarAST) input.LT(1);
              b = (GrammarAST) match(input, STRING_LITERAL, FOLLOW_STRING_LITERAL_in_setElement433);
              if (state.failed) return retval;
    ...
    try {
      ...
      // org/antlr/v4/parse/BlockSetTransformer.g:96:4: ^( ELEMENT_OPTIONS ( elementOption )* )
      {
        _last = (GrammarAST) input.LT(1);
        {
          ...
          GrammarAST _first_1 = null;
          _last = (GrammarAST) input.LT(1);
          ELEMENT_OPTIONS28 = (GrammarAST) match(input, ELEMENT_OPTIONS, FOLLOW_ELEMENT_OPTIONS_in_elementOptions455);
          if (state.failed) return retval;
  ...
  public final BlockSetTransformer.elementOption_return elementOption() throws RecognitionException {
    ...
    try {
      ...
      switch (alt13) {
        ...
        {
          _last = (GrammarAST) input.LT(1);
          ID30 = (GrammarAST) match(input, ID, FOLLOW_ID_in_elementOption470);
          if (state.failed) return retval;
          ...
          // org/antlr/v4/parse/BlockSetTransformer.g:101:4: ^( ASSIGN id= ID v= ID )
        {
          _last = (GrammarAST) input.LT(1);
          {
            ...
            GrammarAST _first_1 = null;
            _last = (GrammarAST) input.LT(1);
            ASSIGN31 = (GrammarAST) match(input, ASSIGN, FOLLOW_ASSIGN_in_elementOption476);
            if (state.failed) return retval;
            ...
            if (state.failed) return retval;
            _last = (GrammarAST) input.LT(1);
            id = (GrammarAST) match(input, ID, FOLLOW_ID_in_elementOption480);
            if (state.failed) return retval;
            ...
            _last = (GrammarAST) input.LT(1);
            v = (GrammarAST) match(input, ID, FOLLOW_ID_in_elementOption484);
            if (state.failed) return retval;
          ...
          // org/antlr/v4/parse/BlockSetTransformer.g:102:4: ^( ASSIGN ID v= STRING_LITERAL )
        {
          _last = (GrammarAST) input.LT(1);
          {
            ...
            GrammarAST _first_1 = null;
            _last = (GrammarAST) input.LT(1);
            ASSIGN32 = (GrammarAST) match(input, ASSIGN, FOLLOW_ASSIGN_in_elementOption491);
            if (state.failed) return retval;
            ...
            if (state.failed) return retval;
            _last = (GrammarAST) input.LT(1);
            ID33 = (GrammarAST) match(input, ID, FOLLOW_ID_in_elementOption493);
            if (state.failed) return retval;
            ...
            _last = (GrammarAST) input.LT(1);
            v = (GrammarAST) match(input, STRING_LITERAL, FOLLOW_STRING_LITERAL_in_elementOption497);
            if (state.failed) return retval;
          ...
          // org/antlr/v4/parse/BlockSetTransformer.g:103:4: ^( ASSIGN ID v= ACTION )
        {
          _last = (GrammarAST) input.LT(1);
          {
            ...
            GrammarAST _first_1 = null;
            _last = (GrammarAST) input.LT(1);
            ASSIGN34 = (GrammarAST) match(input, ASSIGN, FOLLOW_ASSIGN_in_elementOption504);
            if (state.failed) return retval;
            ...
            if (state.failed) return retval;
            _last = (GrammarAST) input.LT(1);
            ID35 = (GrammarAST) match(input, ID, FOLLOW_ID_in_elementOption506);
            if (state.failed) return retval;
            ...
            _last = (GrammarAST) input.LT(1);
            v = (GrammarAST) match(input, ACTION, FOLLOW_ACTION_in_elementOption510);
            if (state.failed) return retval;
          ...
          // org/antlr/v4/parse/BlockSetTransformer.g:104:4: ^( ASSIGN ID v= INT )
        {
          _last = (GrammarAST) input.LT(1);
          {
            ...
            GrammarAST _first_1 = null;
            _last = (GrammarAST) input.LT(1);
            ASSIGN36 = (GrammarAST) match(input, ASSIGN, FOLLOW_ASSIGN_in_elementOption517);
            if (state.failed) return retval;
            ...
            if (state.failed) return retval;
            _last = (GrammarAST) input.LT(1);
            ID37 = (GrammarAST) match(input, ID, FOLLOW_ID_in_elementOption519);
            if (state.failed) return retval;
            ...
            _last = (GrammarAST) input.LT(1);
            v = (GrammarAST) match(input, INT, FOLLOW_INT_in_elementOption523);
            if (state.failed) return retval;
