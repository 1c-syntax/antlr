 ...
 */
// $ANTLR 3.5.3 org/antlr/v4/parse/ANTLRLexer.g 2025-02-05 09:25:53
      ...
      switch (s) {
        case 0:
          ...
          if ((LA2_18 == '\"')) {
            ...
            s = 14;
          } else if ((LA2_18 == '\t' || LA2_18 == '\f' || LA2_18 == ' ')) {
            s = 23;
          } else if (((LA2_18 >= '\u0000' && LA2_18 <= '\b') || LA2_18 == '\u000B' || (LA2_18 >= '\u000E' && LA2_18 <= '\u001F') || LA2_18 == '!' || (LA2_18 >= '#' && LA2_18 <= '[') || (LA2_18 >= ']' && LA2_18 <= '\uFFFF'))) {
            s = 15;
          } else if ((LA2_18 == '\n' || LA2_18 == '\r') && (synpred1_ANTLRLexer())) {
            s = 17;
          } else s = 2;
        ...
        case 1:
          ...
          if ((LA2_23 == '\"')) {
            ...
            s = 14;
          } else if (((LA2_23 >= '0' && LA2_23 <= '9'))) {
            s = 25;
          } else if ((LA2_23 == '\t' || LA2_23 == '\f' || LA2_23 == ' ')) {
            s = 23;
          } else if (((LA2_23 >= '\u0000' && LA2_23 <= '\b') || LA2_23 == '\u000B' || (LA2_23 >= '\u000E' && LA2_23 <= '\u001F') || LA2_23 == '!' || (LA2_23 >= '#' && LA2_23 <= '/') || (LA2_23 >= ':' && LA2_23 <= '[') || (LA2_23 >= ']' && LA2_23 <= '\uFFFF'))) {
            s = 15;
          } else if ((LA2_23 == '\n' || LA2_23 == '\r') && (synpred1_ANTLRLexer())) {
            s = 17;
          } else s = 2;
        ...
        case 2:
          ...
          if ((LA2_15 == '\"')) {
            ...
            s = 14;
          } else if (((LA2_15 >= '\u0000' && LA2_15 <= '\t') || (LA2_15 >= '\u000B' && LA2_15 <= '\f') || (LA2_15 >= '\u000E' && LA2_15 <= '!') || (LA2_15 >= '#' && LA2_15 <= '[') || (LA2_15 >= ']' && LA2_15 <= '\uFFFF'))) {
            s = 15;
          } else if ((LA2_15 == '\n' || LA2_15 == '\r') && (synpred1_ANTLRLexer())) {
            s = 17;
          } else s = 2;
        ...
        case 3:
          ...
          if ((LA2_20 == '\"')) {
            ...
            s = 14;
          } else if (((LA2_20 >= '\u0000' && LA2_20 <= '\t') || (LA2_20 >= '\u000B' && LA2_20 <= '\f') || (LA2_20 >= '\u000E' && LA2_20 <= '!') || (LA2_20 >= '#' && LA2_20 <= '[') || (LA2_20 >= ']' && LA2_20 <= '\uFFFF'))) {
            s = 15;
          } else if ((LA2_20 == '\n' || LA2_20 == '\r') && (synpred1_ANTLRLexer())) {
            s = 17;
          } else s = 2;
        ...
        case 4:
          ...
          if ((LA2_13 == '\\')) {
            s = 14;
          } else if (((LA2_13 >= '\u0000' && LA2_13 <= '\t') || (LA2_13 >= '\u000B' && LA2_13 <= '\f') || (LA2_13 >= '\u000E' && LA2_13 <= '!') || (LA2_13 >= '#' && LA2_13 <= '[') || (LA2_13 >= ']' && LA2_13 <= '\uFFFF'))) {
            s = 15;
          } else if ((LA2_13 == '\"')) {
            s = 16;
          } else if ((LA2_13 == '\n' || LA2_13 == '\r') && (synpred1_ANTLRLexer())) {
            s = 17;
          } else s = 2;
        ...
        case 5:
          ...
          if ((LA2_14 == '\"')) {
            ...
            s = 19;
          } else if (((LA2_14 >= '\u0000' && LA2_14 <= '\t') || (LA2_14 >= '\u000B' && LA2_14 <= '\f') || (LA2_14 >= '\u000E' && LA2_14 <= '!') || (LA2_14 >= '#' && LA2_14 <= '[') || (LA2_14 >= ']' && LA2_14 <= '\uFFFF'))) {
            s = 20;
          } else if ((LA2_14 == '\n' || LA2_14 == '\r') && (synpred1_ANTLRLexer())) {
            s = 21;
          } else s = 2;
        ...
        case 7:
          ...
          if ((LA2_19 == '\"')) {
            ...
            s = 19;
          } else if (((LA2_19 >= '\u0000' && LA2_19 <= '\t') || (LA2_19 >= '\u000B' && LA2_19 <= '\f') || (LA2_19 >= '\u000E' && LA2_19 <= '!') || (LA2_19 >= '#' && LA2_19 <= '[') || (LA2_19 >= ']' && LA2_19 <= '\uFFFF'))) {
            s = 20;
          } else if ((LA2_19 == '\n' || LA2_19 == '\r') && (synpred1_ANTLRLexer())) {
            s = 21;
          } else s = 2;
    ...
    public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
      ...
      switch (s) {
        case 0:
          ...
          input.rewind();
          s = -1;
          if (((LA35_2 >= '\u0000' && LA35_2 <= '\t') || (LA35_2 >= '\u000B' && LA35_2 <= '\f') || (LA35_2 >= '\u000E' && LA35_2 <= '\uFFFF')) && (((!isLexerRule) || (isLexerRule)))) {
            s = 40;
          } else if ((LA35_2 == '\n' || LA35_2 == '\r') && ((!isLexerRule))) {
            s = 41;
          } else s = 38;
        ...
        case 1:
          ...
          if ((LA35_0 == '/')) {
            ...
            s = 32;
          } else if (((LA35_0 >= 'A' && LA35_0 <= 'Z') || (LA35_0 >= 'a' && LA35_0 <= 'b') || (LA35_0 >= 'd' && LA35_0 <= 'e') || LA35_0 == 'h' || (LA35_0 >= 'j' && LA35_0 <= 'k') || LA35_0 == 'n' || LA35_0 == 'q' || LA35_0 == 's' || (LA35_0 >= 'u' && LA35_0 <= 'z') || (LA35_0 >= '\u00C0' && LA35_0 <= '\u00D6') || (LA35_0 >= '\u00D8' && LA35_0 <= '\u00F6') || (LA35_0 >= '\u00F8' && LA35_0 <= '\u02FF') || (LA35_0 >= '\u0370' && LA35_0 <= '\u037D') || (LA35_0 >= '\u037F' && LA35_0 <= '\u1FFF') || (LA35_0 >= '\u200C' && LA35_0 <= '\u200D') || (LA35_0 >= '\u2070' && LA35_0 <= '\u218F') || (LA35_0 >= '\u2C00' && LA35_0 <= '\u2FEF') || (LA35_0 >= '\u3001' && LA35_0 <= '\uD7FF') || (LA35_0 >= '\uF900' && LA35_0 <= '\uFDCF') || (LA35_0 >= '\uFDF0' && LA35_0 <= '\uFEFE') || (LA35_0 >= '\uFF00' && LA35_0 <= '\uFFFD'))) {
            s = 33;
            ...
            s = 37;
          } else if (((LA35_0 >= '\u0000' && LA35_0 <= '\b') || LA35_0 == '\u000B' || (LA35_0 >= '\u000E' && LA35_0 <= '\u001F') || (LA35_0 >= '!' && LA35_0 <= '\"') || (LA35_0 >= '%' && LA35_0 <= '&') || (LA35_0 >= '\\' && LA35_0 <= '`') || (LA35_0 >= '\u007F' && LA35_0 <= '\u00BF') || LA35_0 == '\u00D7' || LA35_0 == '\u00F7' || (LA35_0 >= '\u0300' && LA35_0 <= '\u036F') || LA35_0 == '\u037E' || (LA35_0 >= '\u2000' && LA35_0 <= '\u200B') || (LA35_0 >= '\u200E' && LA35_0 <= '\u206F') || (LA35_0 >= '\u2190' && LA35_0 <= '\u2BFF') || (LA35_0 >= '\u2FF0' && LA35_0 <= '\u3000') || (LA35_0 >= '\uD800' && LA35_0 <= '\uF8FF') || (LA35_0 >= '\uFDD0' && LA35_0 <= '\uFDEF') || (LA35_0 >= '\uFFFE' && LA35_0 <= '\uFFFF'))) {
            s = 38;
          }
          if (s >= 0) return s;
          break;
