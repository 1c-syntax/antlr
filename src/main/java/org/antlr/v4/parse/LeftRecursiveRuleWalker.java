 ...
 */
// $ANTLR 3.5.3 org/antlr/v4/parse/LeftRecursiveRuleWalker.g 2025-02-05 09:25:54
...
public class LeftRecursiveRuleWalker extends TreeParser {
  ...
  public final boolean rec_rule() throws RecognitionException {
    ...
    try {
      ...
      {
        r = (GrammarAST) match(input, RULE, FOLLOW_RULE_in_rec_rule72);
        if (state.failed) return isLeftRec;
        match(input, Token.DOWN, null);
        if (state.failed) return isLeftRec;
        id = (GrammarAST) match(input, RULE_REF, FOLLOW_RULE_REF_in_rec_rule76);
        if (state.failed) return isLeftRec;
        ...
        switch (alt2) {
          ...
          {
            match(input, RETURNS, FOLLOW_RETURNS_in_rec_rule92);
            if (state.failed) return isLeftRec;
            match(input, Token.DOWN, null);
            if (state.failed) return isLeftRec;
            a = (GrammarAST) match(input, ARG_ACTION, FOLLOW_ARG_ACTION_in_rec_rule96);
            if (state.failed) return isLeftRec;
            if (state.backtracking == 0) {
              setReturnValues(a);
            }
        ...
        switch (alt3) {
          ...
          {
            match(input, LOCALS, FOLLOW_LOCALS_in_rec_rule115);
            if (state.failed) return isLeftRec;
            match(input, Token.DOWN, null);
            if (state.failed) return isLeftRec;
            match(input, ARG_ACTION, FOLLOW_ARG_ACTION_in_rec_rule117);
            if (state.failed) return isLeftRec;
            match(input, Token.UP, null);
            if (state.failed) return isLeftRec;
        ...
        while (true) {
          ...
          switch (alt5) {
            ...
            {
              match(input, OPTIONS, FOLLOW_OPTIONS_in_rec_rule135);
              if (state.failed) return isLeftRec;
            ...
            {
              match(input, AT, FOLLOW_AT_in_rec_rule152);
              if (state.failed) return isLeftRec;
              match(input, Token.DOWN, null);
              if (state.failed) return isLeftRec;
              match(input, ID, FOLLOW_ID_in_rec_rule154);
              if (state.failed) return isLeftRec;
              match(input, ACTION, FOLLOW_ACTION_in_rec_rule156);
              if (state.failed) return isLeftRec;
              match(input, Token.UP, null);
              if (state.failed) return isLeftRec;
        ...
        if (state.failed) return isLeftRec;
        if (state.backtracking == 0) {
          isLeftRec = (ruleBlock1 != null ? ((LeftRecursiveRuleWalker.ruleBlock_return) ruleBlock1).isLeftRec : false);
        }
  ...
  public final void exceptionHandler() throws RecognitionException {
    try {
      ...
      {
        match(input, CATCH, FOLLOW_CATCH_in_exceptionHandler216);
        if (state.failed) return;
        match(input, Token.DOWN, null);
        if (state.failed) return;
        match(input, ARG_ACTION, FOLLOW_ARG_ACTION_in_exceptionHandler218);
        if (state.failed) return;
        match(input, ACTION, FOLLOW_ACTION_in_exceptionHandler220);
        if (state.failed) return;
        match(input, Token.UP, null);
        if (state.failed) return;
  ...
  public final void finallyClause() throws RecognitionException {
    try {
      ...
      {
        match(input, FINALLY, FOLLOW_FINALLY_in_finallyClause233);
        if (state.failed) return;
        match(input, Token.DOWN, null);
        if (state.failed) return;
        match(input, ACTION, FOLLOW_ACTION_in_finallyClause235);
        if (state.failed) return;
        match(input, Token.UP, null);
        if (state.failed) return;
  ...
  public final LeftRecursiveRuleWalker.ruleBlock_return ruleBlock() throws RecognitionException {
    ...
    try {
      ...
      {
        match(input, BLOCK, FOLLOW_BLOCK_in_ruleBlock290);
        ...
        while (true) {
          ...
          switch (alt8) {
              ...
              // org/antlr/v4/parse/LeftRecursiveRuleWalker.g:81:5: o= outerAlternative
            {
              ...
              if (state.failed) return retval;
              if (state.backtracking == 0) {
                if ((o != null ? ((LeftRecursiveRuleWalker.outerAlternative_return) o).isLeftRec : false))
    ...
    try {
      ...
      switch (alt9) {
          ...
          // org/antlr/v4/parse/LeftRecursiveRuleWalker.g:90:9: ( binary )=> binary
        {
          ...
          if (state.failed) return retval;
          if (state.backtracking == 0) {
            binaryAlt((AltAST) ((GrammarAST) retval.start), currentOuterAltNumber);
            retval.isLeftRec = true;
          }
        }
        break;
          ...
          // org/antlr/v4/parse/LeftRecursiveRuleWalker.g:92:9: ( prefix )=> prefix
        {
          ...
          if (state.failed) return retval;
          if (state.backtracking == 0) {
            prefixAlt((AltAST) ((GrammarAST) retval.start), currentOuterAltNumber);
          }
        }
        break;
        case 3:
          // org/antlr/v4/parse/LeftRecursiveRuleWalker.g:94:9: ( suffix )=> suffix
        {
          ...
          if (state.failed) return retval;
          if (state.backtracking == 0) {
            suffixAlt((AltAST) ((GrammarAST) retval.start), currentOuterAltNumber);
            retval.isLeftRec = true;
          }
        }
        break;
          ...
          // org/antlr/v4/parse/LeftRecursiveRuleWalker.g:96:9: nonLeftRecur
        {
          ...
          if (state.failed) return retval;
          if (state.backtracking == 0) {
            otherAlt((AltAST) ((GrammarAST) retval.start), currentOuterAltNumber);
          }
        }
        break;
  ...
  public final void binary() throws RecognitionException {
    ...
    try {
      ...
      {
        ALT2 = (GrammarAST) match(input, ALT, FOLLOW_ALT_in_binary541);
        if (state.failed) return;
        match(input, Token.DOWN, null);
        if (state.failed) return;
        ...
        if (state.backtracking == 0) {
          setAltAssoc((AltAST) ALT2, currentOuterAltNumber);
        }
      }
  ...
  public final void prefix() throws RecognitionException {
    ...
    try {
      ...
      {
        ALT3 = (GrammarAST) match(input, ALT, FOLLOW_ALT_in_prefix579);
        if (state.failed) return;
        match(input, Token.DOWN, null);
        if (state.failed) return;
        ...
        if (state.backtracking == 0) {
          setAltAssoc((AltAST) ALT3, currentOuterAltNumber);
        }
      }
  ...
  public final void suffix() throws RecognitionException {
    ...
    try {
      ...
      {
        ALT4 = (GrammarAST) match(input, ALT, FOLLOW_ALT_in_suffix630);
        if (state.failed) return;
        match(input, Token.DOWN, null);
        if (state.failed) return;
        ...
        if (state.backtracking == 0) {
          setAltAssoc((AltAST) ALT4, currentOuterAltNumber);
        }
      }
  ...
  public final void nonLeftRecur() throws RecognitionException {
    try {
      ...
      {
        match(input, ALT, FOLLOW_ALT_in_nonLeftRecur671);
        if (state.failed) return;
        match(input, Token.DOWN, null);
        if (state.failed) return;
  ...
  public final void recurse() throws RecognitionException {
    try {
      ...
      switch (alt20) {
        ...
        {
          match(input, ASSIGN, FOLLOW_ASSIGN_in_recurse693);
          if (state.failed) return;
          match(input, Token.DOWN, null);
          if (state.failed) return;
          match(input, ID, FOLLOW_ID_in_recurse695);
          if (state.failed) return;
        ...
        {
          match(input, PLUS_ASSIGN, FOLLOW_PLUS_ASSIGN_in_recurse704);
          if (state.failed) return;
          match(input, Token.DOWN, null);
          if (state.failed) return;
          match(input, ID, FOLLOW_ID_in_recurse706);
          if (state.failed) return;
  ...
  public final void recurseNoLabel() throws RecognitionException {
    try {
      ...
      // org/antlr/v4/parse/LeftRecursiveRuleWalker.g:127:18: {...}? RULE_REF
      {
        ...
        match(input, RULE_REF, FOLLOW_RULE_REF_in_recurseNoLabel726);
        if (state.failed) return;
      }
  ...
  public final GrammarAST token() throws RecognitionException {
    ...
    try {
      ...
      switch (alt21) {
        ...
        {
          match(input, ASSIGN, FOLLOW_ASSIGN_in_token740);
          if (state.failed) return t;
          match(input, Token.DOWN, null);
          if (state.failed) return t;
          match(input, ID, FOLLOW_ID_in_token742);
          if (state.failed) return t;
          ...
          // org/antlr/v4/parse/LeftRecursiveRuleWalker.g:131:4: ^( PLUS_ASSIGN ID s= token )
        {
          ...
          match(input, Token.DOWN, null);
          if (state.failed) return t;
          match(input, ID, FOLLOW_ID_in_token757);
          if (state.failed) return t;
        ...
        {
          b = (GrammarAST) match(input, STRING_LITERAL, FOLLOW_STRING_LITERAL_in_token771);
          if (state.failed) return t;
          if (state.backtracking == 0) {
            t = b;
          }
        ...
        {
          b = (GrammarAST) match(input, STRING_LITERAL, FOLLOW_STRING_LITERAL_in_token792);
          if (state.failed) return t;
          match(input, Token.DOWN, null);
          if (state.failed) return t;
        ...
        {
          c = (GrammarAST) match(input, TOKEN_REF, FOLLOW_TOKEN_REF_in_token809);
          if (state.failed) return t;
          match(input, Token.DOWN, null);
          if (state.failed) return t;
        ...
        {
          c = (GrammarAST) match(input, TOKEN_REF, FOLLOW_TOKEN_REF_in_token823);
          if (state.failed) return t;
          if (state.backtracking == 0) {
            t = c;
          }
  ...
  public final void elementOptions() throws RecognitionException {
    try {
      ...
      {
        match(input, ELEMENT_OPTIONS, FOLLOW_ELEMENT_OPTIONS_in_elementOptions853);
        if (state.failed) return;
        if (input.LA(1) == Token.DOWN) {
          match(input, Token.DOWN, null);
          if (state.failed) return;
  ...
  public final void elementOption() throws RecognitionException {
    try {
      ...
      switch (alt23) {
        ...
        {
          match(input, ID, FOLLOW_ID_in_elementOption874);
          if (state.failed) return;
        }
        break;
        case 2:
        ...
        {
          match(input, ASSIGN, FOLLOW_ASSIGN_in_elementOption885);
          if (state.failed) return;
          match(input, Token.DOWN, null);
          if (state.failed) return;
          match(input, ID, FOLLOW_ID_in_elementOption887);
          if (state.failed) return;
          match(input, ID, FOLLOW_ID_in_elementOption889);
          if (state.failed) return;
          match(input, Token.UP, null);
          if (state.failed) return;
        ...
        {
          match(input, ASSIGN, FOLLOW_ASSIGN_in_elementOption901);
          if (state.failed) return;
          match(input, Token.DOWN, null);
          if (state.failed) return;
          match(input, ID, FOLLOW_ID_in_elementOption903);
          if (state.failed) return;
          match(input, STRING_LITERAL, FOLLOW_STRING_LITERAL_in_elementOption905);
          if (state.failed) return;
          match(input, Token.UP, null);
          if (state.failed) return;
        ...
        {
          match(input, ASSIGN, FOLLOW_ASSIGN_in_elementOption917);
          if (state.failed) return;
          match(input, Token.DOWN, null);
          if (state.failed) return;
          match(input, ID, FOLLOW_ID_in_elementOption919);
          if (state.failed) return;
          match(input, ACTION, FOLLOW_ACTION_in_elementOption921);
          if (state.failed) return;
          match(input, Token.UP, null);
          if (state.failed) return;
        ...
        {
          match(input, ASSIGN, FOLLOW_ASSIGN_in_elementOption933);
          if (state.failed) return;
          match(input, Token.DOWN, null);
          if (state.failed) return;
          match(input, ID, FOLLOW_ID_in_elementOption935);
          if (state.failed) return;
          match(input, INT, FOLLOW_INT_in_elementOption937);
          if (state.failed) return;
          match(input, Token.UP, null);
          if (state.failed) return;
  ...
  public final void element() throws RecognitionException {
    try {
      ...
      switch (alt25) {
        ...
        {
          match(input, NOT, FOLLOW_NOT_in_element958);
          if (state.failed) return;
          match(input, Token.DOWN, null);
          if (state.failed) return;
        ...
        {
          match(input, RANGE, FOLLOW_RANGE_in_element967);
          if (state.failed) return;
          match(input, Token.DOWN, null);
          if (state.failed) return;
        ...
        {
          match(input, ASSIGN, FOLLOW_ASSIGN_in_element978);
          if (state.failed) return;
          match(input, Token.DOWN, null);
          if (state.failed) return;
          match(input, ID, FOLLOW_ID_in_element980);
          if (state.failed) return;
        ...
        {
          match(input, PLUS_ASSIGN, FOLLOW_PLUS_ASSIGN_in_element989);
          if (state.failed) return;
          match(input, Token.DOWN, null);
          if (state.failed) return;
          match(input, ID, FOLLOW_ID_in_element991);
          if (state.failed) return;
        ...
        {
          match(input, SET, FOLLOW_SET_in_element1003);
          if (state.failed) return;
          match(input, Token.DOWN, null);
          if (state.failed) return;
        ...
        {
          match(input, RULE_REF, FOLLOW_RULE_REF_in_element1017);
          if (state.failed) return;
        }
        break;
        case 8:
  ...
  public final void epsilonElement() throws RecognitionException {
    try {
      ...
      switch (alt26) {
        ...
        {
          match(input, ACTION, FOLLOW_ACTION_in_epsilonElement1038);
          if (state.failed) return;
        }
        break;
        case 2:
        ...
        {
          match(input, SEMPRED, FOLLOW_SEMPRED_in_epsilonElement1043);
          if (state.failed) return;
        }
        break;
        case 3:
        ...
        {
          match(input, EPSILON, FOLLOW_EPSILON_in_epsilonElement1048);
          if (state.failed) return;
        }
        break;
        case 4:
        ...
        {
          match(input, ACTION, FOLLOW_ACTION_in_epsilonElement1054);
          if (state.failed) return;
          match(input, Token.DOWN, null);
          if (state.failed) return;
        ...
        {
          match(input, SEMPRED, FOLLOW_SEMPRED_in_epsilonElement1063);
          if (state.failed) return;
          match(input, Token.DOWN, null);
          if (state.failed) return;
  ...
  public final void setElement() throws RecognitionException {
    try {
      ...
      switch (alt27) {
        ...
        {
          match(input, STRING_LITERAL, FOLLOW_STRING_LITERAL_in_setElement1078);
          if (state.failed) return;
          match(input, Token.DOWN, null);
          if (state.failed) return;
        ...
        {
          match(input, TOKEN_REF, FOLLOW_TOKEN_REF_in_setElement1087);
          if (state.failed) return;
          match(input, Token.DOWN, null);
          if (state.failed) return;
        ...
        {
          match(input, STRING_LITERAL, FOLLOW_STRING_LITERAL_in_setElement1095);
          if (state.failed) return;
        }
        break;
        case 4:
        ...
        {
          match(input, TOKEN_REF, FOLLOW_TOKEN_REF_in_setElement1100);
          if (state.failed) return;
        }
        break;
  ...
  public final void ebnf() throws RecognitionException {
    try {
      ...
      switch (alt28) {
        ...
        {
          match(input, OPTIONAL, FOLLOW_OPTIONAL_in_ebnf1123);
          if (state.failed) return;
          match(input, Token.DOWN, null);
          if (state.failed) return;
        ...
        {
          match(input, CLOSURE, FOLLOW_CLOSURE_in_ebnf1139);
          if (state.failed) return;
          match(input, Token.DOWN, null);
          if (state.failed) return;
        ...
        {
          match(input, POSITIVE_CLOSURE, FOLLOW_POSITIVE_CLOSURE_in_ebnf1155);
          if (state.failed) return;
          match(input, Token.DOWN, null);
          if (state.failed) return;
  ...
  public final void block() throws RecognitionException {
    try {
      ...
      {
        match(input, BLOCK, FOLLOW_BLOCK_in_block1177);
        if (state.failed) return;
        match(input, Token.DOWN, null);
        if (state.failed) return;
  ...
  public final void alternative() throws RecognitionException {
    try {
      ...
      {
        match(input, ALT, FOLLOW_ALT_in_alternative1199);
        if (state.failed) return;
        match(input, Token.DOWN, null);
        if (state.failed) return;
  ...
  public final void atom() throws RecognitionException {
    try {
      ...
      switch (alt35) {
        ...
        {
          match(input, RULE_REF, FOLLOW_RULE_REF_in_atom1221);
          if (state.failed) return;
          if (input.LA(1) == Token.DOWN) {
            match(input, Token.DOWN, null);
            if (state.failed) return;
            ...
            switch (alt33) {
              case 1:
                // org/antlr/v4/parse/LeftRecursiveRuleWalker.g:192:15: ARG_ACTION
              {
                match(input, ARG_ACTION, FOLLOW_ARG_ACTION_in_atom1223);
                if (state.failed) return;
              }
              break;
        ...
        {
          match(input, STRING_LITERAL, FOLLOW_STRING_LITERAL_in_atom1238);
          if (state.failed) return;
          match(input, Token.DOWN, null);
          if (state.failed) return;
        ...
        {
          match(input, STRING_LITERAL, FOLLOW_STRING_LITERAL_in_atom1246);
          if (state.failed) return;
        }
        break;
        case 4:
        ...
        {
          match(input, TOKEN_REF, FOLLOW_TOKEN_REF_in_atom1255);
          if (state.failed) return;
          match(input, Token.DOWN, null);
          if (state.failed) return;
        ...
        {
          match(input, TOKEN_REF, FOLLOW_TOKEN_REF_in_atom1263);
          if (state.failed) return;
        }
        break;
        case 6:
        ...
        {
          match(input, WILDCARD, FOLLOW_WILDCARD_in_atom1272);
          if (state.failed) return;
          match(input, Token.DOWN, null);
          if (state.failed) return;
        ...
        {
          match(input, WILDCARD, FOLLOW_WILDCARD_in_atom1280);
          if (state.failed) return;
        }
        break;
        case 8:
        ...
        {
          match(input, DOT, FOLLOW_DOT_in_atom1286);
          if (state.failed) return;
          match(input, Token.DOWN, null);
          if (state.failed) return;
          match(input, ID, FOLLOW_ID_in_atom1288);
          if (state.failed) return;
